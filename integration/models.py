...
class InvestigadorGrupo(models.Model):
    ...
    nombre_investigador = models.CharField(
    ...
    clasificacion_grupo = models.CharField(
        max_length=50, null=True, blank=True, verbose_name="Clasificación del grupo"
    )

    fecha_vinculacion = models.DateField(
        default=timezone.now, verbose_name="Fecha de vinculación"
    )
    ...
    creado_por = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="Creado por"
    )
...
class BusquedaLog(models.Model):
    ...
    resultados_count = models.IntegerField(
