...
class InvestigadorGrupoAdmin(admin.ModelAdmin):
        ...
        if "action" in request.GET and "id" in request.GET:
            ...
            try:
                ...
                if action == "activar":
                    ...
                    messages.success(
                        request,
                        f"Investigador {obj.nombre_investigador} activado en el grupo {obj.nombre_grupo}",
                    )
                    ...
                    messages.success(
                        request,
                        f"Investigador {obj.nombre_investigador} desactivado del grupo {obj.nombre_grupo}",
                    )
    ...
    def buscar_investigador_view(self, request):
        context = {
            ...
            "site_header": getattr(
                settings, "ADMIN_SITE_HEADER", "Django administration"
            ),
